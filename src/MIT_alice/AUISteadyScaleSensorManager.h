...
class AUISteadyScaleSensorManager : public AUISensorManager
{
public:
    AUISteadyScaleSensorManager() {}
    virtual ~AUISteadyScaleSensorManager() {}
    virtual AUICoordSpace TargetCoordSpace() { return AUICoordSpace::kSteadyScale; }
